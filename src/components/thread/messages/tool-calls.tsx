import type { AIMessage, ToolMessage } from "@/lib/agent-types";
        ...
        >
          ...
          {((shouldTruncate && !isJsonContent) ||
            ...
            <motion.button
              ...
              className="flex w-full cursor-pointer items-center justify-center border-t-[1px] border-border py-2 text-muted-foreground transition-all duration-200 ease-in-out hover:bg-accent/50 hover:text-foreground/80"
              initial={{ scale: 1 }}
