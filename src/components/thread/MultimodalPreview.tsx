    ...
    return (
      <div className={cn("relative inline-block", className)}>
        ...
        {removable && (
          <button
            type="button"
            className="absolute top-1 right-1 z-10 rounded-full bg-muted-foreground text-primary-foreground hover:bg-foreground/80"
            onClick={onRemove}
  ...
  if (block.type === "file" && block.mimeType === "application/pdf") {
    ...
    return (
      ...
      >
        ...
        <span
          className={cn("min-w-0 flex-1 text-sm break-all text-foreground/80")}
